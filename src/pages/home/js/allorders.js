...
define(
    [
        ...
        './components/orders/allorders'
        
    ],
    function(React, ReactDOM, $, Raphael, Morris, HeaderBar, NavigationMenu, ControlPanel, DonutChart, AreaChart, WorldMap, ContainerOne, ContainerTwo, ContainerThree, ContainerFour,ContainerFive,ContainerSix,ContainerSeven,ControlsMenu,StatTile,AllOrders){
        var MainAllOrders = React.createClass({
            render: function(){
                var style = {
                    position: 'relative',
                    height: '300px'
                    ...
                    <div className="wrapper">
                        ...
                        <div className="content-wrapper">
                            <section className="content-header">
                                <h1>
                                    Orders
                                    <small>A snapshot of all the recent orders</small>
                                </h1>
        ...
        ReactDOM.render(<MainAllOrders />,  document.getElementById('allorders-container'));
    }   
)  